...
ng [] that flattens to nothing)

    @author: Aron Nieminen, Mojang AB"""

""" Updated to include func
    ...
    (Because of this, it's possible to "erase" arguments. CmdPlayer removes
     entityId, by injectitionality provided by RaspberryJuice:
- getBlocks()
- getDirection()
- getPitch()
- getRotation()
...
class Minecraft:
    ...
    def getTargetBlock(self):
        s = self.conn.sendReceive(b"player.getTargetBlock")
        return Vec3(*list(map(int, s.split(","))))
